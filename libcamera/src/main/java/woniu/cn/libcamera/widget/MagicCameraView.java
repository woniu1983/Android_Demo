...
import woniu.cn.libcamera.camera.CameraInfo;
import woniu.cn.libcamera.camera.encoder.video.TextureMovieEncoder;
import woniu.cn.libcamera.camera.filter.advanced.MagicBeautyFilter;
import woniu.cn.libcamera.camera.filter.base.MagicCameraInputFilter;
...
public class MagicCameraView extends MagicBaseView implements IActivityLifiCycle {
    ...
    private SurfaceTexture.OnFrameAvailableListener onFrameAvailableListener = new SurfaceTexture.OnFrameAvailableListener() {
        ...
        public void onFrameAvailable(SurfaceTexture surfaceTexture) {
            Log.i("MagicCameraView", "----> Call requestRender to refresh frame in screeen");
//            try {
//                Thread.sleep(10);
